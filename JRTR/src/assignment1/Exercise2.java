...
public class Exercise2 {
	...
	public static void main(String[] args) throws IOException{
		...
		glTeapot.configurePreferredShader("shaders/default.vert", "shaders/default.frag", null);
		...
		glTeapot2.configurePreferredShader("shaders/trimesh_flat.vert", "shaders/trimesh_flat.frag", "shaders/trimesh_flat.geom");
