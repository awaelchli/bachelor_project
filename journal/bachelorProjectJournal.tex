...
\begin{figure}[h]
	...
	\begin{subfigure}[c]{0.5\textwidth}
 		\includegraphics[scale=1]{sketches/sheared_projections_layers_overview.pdf} 
  		\caption{Ray coming from a pixel on layer $s^2$ intersecting the sensor plane $x$ and the topmost  layer $s^1$. }
	\end{subfigure}%
	~
	\begin{subfigure}[c]{0.5\textwidth}
		\caption{?}
