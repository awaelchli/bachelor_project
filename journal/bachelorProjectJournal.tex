...
\begin{figure}[h]
	...
	\end{subfigure}%
	\caption{Calculation of the intersections and the weights.}
...
\begin{enumerate}
	...
	\item	Rays from layers to sensor (figure \ref{fig:problem_layers_to_camera})
		\begin{itemize}
			...
			\item[$+$]	No need to adjust/shear the camera images
		\end{itemize}
	\item	Rays from bottom-most layer, weights intersection on layers + sensor (figure \ref{fig:intersections_and_weights_overview})
		\begin{itemize}
