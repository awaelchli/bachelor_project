...
The key idea is to use a kernel to weight the ray-pixel-correspondences. As depicted in \ref{fig:intersections_and_weights}, the weight is computed from the deviation of the pixel center. For any ray, we select the nearest pixel and then calculate the weight. We consider and test the following main configurations:
