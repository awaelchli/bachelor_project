...
\begin{equation} \label{eq:minimize_norm}
	\begin{aligned}
		& \underset{\alpha}{\text{argmin}} 	& & \lVert P \alpha + \bar{L} \rVert ^2 \\
...
The convergence of SART has been studied by \cite{ConvergenceSART2}.
They have proven that SART converges to a weighted least squares solution.