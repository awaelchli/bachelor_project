...
Let $\theta_i$ denote the angle of the \mbox{$i$-th} view $L(\theta_i, s)$ from the light field.
The intersection of the ray $(\theta_i, s)$ with the \mbox{$n$-th} layer is simply
\begin{equation}\label{eq:layer_intersection}
	s_n = s + \Delta z \tan (\theta_i), 
\end{equation}
where $\Delta z = z_0 - z_n$ is the distance between the image plane and layer $n$.

%TODO: Insert text for caption
%TODO: Naming layer axes
%TODO: Naming layer spacing
\begin{figure}
	\centering
