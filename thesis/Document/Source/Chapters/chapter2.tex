...
\begin{figure}[htb]
	\subfigure[]{
		\centering
		\frame{
			\includegraphics[height = 0.15\linewidth]{epi_1x500x1000x1000/overview}
		}
	...
	\subfigure[]{
		\centering
%		\frame{
%			\includegraphics[height = 0.15\linewidth]{epi_1x500x1000x1000/scanY=379}
%		}
	...
	\subfigure[]{
		\centering
		\frame{
			\includegraphics[height = 0.15\linewidth]{epi_1x500x1000x1000/scanY=641}
		}
		\label{fig:fig:epi_1x500x1000x1000_scanline2}
	}
	\caption{(a) Raw 3D light field rendered from 500 positions along a horizontal baseline.
			 ...
			 (b) The slope of the epipolar lines from blue and green dice are larger than those from the red die.
			 (c) Epipolar lines of the yellow die have an even larger slope, indicating greater depth.}
...
This means that integrand is only non-zero for points on the ray with coordinates $(u, v, s, t)$.
...
In computed tomography, the radon transform 
