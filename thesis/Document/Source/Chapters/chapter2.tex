...
\begin{figure}[htb]
	\subfigure[]{
		\centering
		\frame{
			\includegraphics[height = 0.16\linewidth]{epi_1x500x1000x1000/overview}
		}
	...
	\subfigure[]{
		\centering
		\frame{
			\includegraphics[height = 0.16\linewidth]{epi_1x500x1000x1000/scanY=379}
		}
	...
	\subfigure[]{
		\centering
		\frame{
			\includegraphics[height = 0.16\linewidth]{epi_1x500x1000x1000/scanY=641}
		}
