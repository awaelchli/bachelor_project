...
The depth range in the light field can immediately be determined by identifying the maximum and minimum slope in the EPI.
...
\begin{figure}[tb]
	...
	\caption{(a) Raw 3D light field rendered from 500 positions along a horizontal baseline.
			 ...
			 (d) Images are cropped according to figure~\ref{fig:RectifiedPerspectiveProjection} such that the disparities of the red die are approximately zero.
